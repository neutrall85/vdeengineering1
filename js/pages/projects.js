window.projectsData = {
  ...
  3: {
    title: 'Альтернативный датчик обнаружения перегрева на ВС Boeing 737-400',
    details: [
      'Установка датчика обнаружения перегрева в зоне размещения Left Aft Air Condition Pack самолета', 
      'Инженерные анализы', 
      'Дополнения в ЭД', 
      'Одобрение второстепенного изменения'
    ],
  ...
  4: {
    title: 'Альтернативные кислородные маски для использования с переносными кислородными баллонами',
    details: [
      'Размещение альтернативных кислородных масок для использования с переносными кислородными баллонами', 
      'Инженерные анализы', 
      'Дополнения в ЭД', 
      'Одобрение второстепенного изменения'
    ],
  ...
  5: {
    title: 'Альтернативные кислородные маски Zodiac AVOX Systems для использования с переносными кислородными баллонами ВС RRJ-95',
    details: [
      'Размещение альтернативных кислородных масок для использования с переносными кислородными баллонами', 
      'Инженерные анализы', 
      'Дополнения в ЭД', 
